        ...
        VStack(spacing: 8) {
            ...
            HStack(spacing: 16) {
                ...
                Button {
                    ...
                    Text("https://docs.google.com/document/d/1HX_uw7owodhgF9653D8dhNwhbdNoGsQJhWuyNaaF7HA/edit?tab=t.0#heading=h.9k1agz8dd6mn")
                        .font(.system(size: 12, weight: .regular))
                        .foregroundColor(.white.opacity(0.3))
                }
            }
...
struct Paywall1_Preview: PreviewProvider {
